...
import com.wlit.fellowship.atmnepal.AboutUs;
...
import com.wlit.fellowship.atmnepal.util.BankListener;
import com.wlit.fellowship.atmnepal.util.MyConstants;
    ...
    public void onDataChange(DataSnapshot dataSnapshot) {
        ...
        for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
            ...
            for (DataSnapshot atmSnapshot : snapshot.child(MyConstants.KEY_ATM_LIST).getChildren()) {
                ...
                atm.setUpdated((String)atmSnapshot.child(MyConstants.KEY_STATUS_UPDATE_TIME).getValue());
